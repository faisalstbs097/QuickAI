...
const Hero = () => {
  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center bg-cover bg-center h-[500px] bg-cover bg-no-repeat min-h-screen " '>
...
const Hero = () => {
    ...
    return (
        <div className='px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center bg-cover bg-center h-[500px] min-h-screen'>
            <div className='text-center mb-6'>
            ...
            <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
                <button onClick={handleStart} className='bg-primary text-white px-10 py-3 rounded-lg hover:scale-102 active:scale-95 transition cursor-pointer'>
                    Start creating now
                </button>
            ...
            <div className='flex items-center gap-4 mt-8 mx-auto text-gray-600'>
                <img src="/assets/user_group.png" alt="User group" className='h-8' /> Trusted by 10k+ people
            </div>
        </div>
    );
};
